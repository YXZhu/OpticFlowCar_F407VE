...
#define VL53L0X_Xshut_RESET HAL_GPIO_WritePin(XSHUT_GPIO_Port,XSHUT_Pin,GPIO_PIN_RESET)
#define VL53L0X_Xshut_SET HAL_GPIO_WritePin(XSHUT_GPIO_Port,XSHUT_Pin,GPIO_PIN_SET)
...
void vl53l0x_reset(VL53L0X_Dev_t *dev)
{
    ...
    VL53L0X_Xshut_RESET;//失能VL53L0X
	delay_ms(30);
	VL53L0X_Xshut_SET;//使能VL53L0X,让传感器处于工作(I2C地址会恢复默认0X52)
	delay_ms(30);	
	dev->I2cDevAddr=0x52;
...
//    HAL_GPIO_Init(GPIOA,&GPIO_Initure);
	...
	VL53L0X_Xshut_RESET;//失能VL53L0X
	delay_ms(30);
	VL53L0X_Xshut_SET;//使能VL53L0X,让传感器处于工作
	delay_ms(30);
...
//		LED0=!LED0;//DS0闪烁
	 ...
	 while(1)
	 {
		 ...
		 if(key)
		 {
			  switch(key)
			  {
				  case 1:  vl53l0x_calibration_test(&vl53l0x_dev),key=3;           break;//校准模式
				  case 2:  vl53l0x_general_test(&vl53l0x_dev);               break;//普通测量模式
				  case 3:  vl53l0x_interrupt_test(&vl53l0x_dev);             break;//中断测量模式  
			  }
			  vl53l0x_mtest_ui();
		 }
//		 i++;
