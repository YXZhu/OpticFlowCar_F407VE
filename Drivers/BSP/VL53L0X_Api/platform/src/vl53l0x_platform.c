...
#define VL53L0X_OsDelay(...) Delay();
#define VL53L0X_GetI2cBus(...) VL53L0X_GetI2cBus1();
#define VL53L0X_PutI2cBus(...) VL53L0X_PutI2cBus1();
...
void VL53L0X_GetI2cBus1()
{
	if(VL53L0XHandle != NULL)
	{
		osMutexWait(I2C2Mutex,500);
	}
}
void VL53L0X_PutI2cBus1()
{
	if(VL53L0XHandle != NULL)
	{
